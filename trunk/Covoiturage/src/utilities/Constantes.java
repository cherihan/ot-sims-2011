...
public class Constantes {
	 ...
	 public static String USER_ALREADY_SAVED = "Cet utilisateur existe d�ja";
	 public static String PROBLEME_CONNECTION_DB = "Pas de connection � la base de de donn�es";
	 public static String OTHER_PROBLEME_IN_CONNECTION_DB = "Connection �chou�e";
	 public static String CLASS_DB_NOT_FOUND = "Ne peut pas trouver les classes du conducteur de la base de donn�es";
